...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public User create(String email, String password, String name, String surname, Role role) {
        User user = new User(name,surname,email,this.passwordEncoder.encode(password),role);
